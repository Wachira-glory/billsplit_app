...
// import { ReceiptText, RefreshCw, Copy, Share2, Printer, Download, CheckCircle2 } from 'lucide-react';
// import { syncBillToUnda } from '@/app/actions/unda';
...
//       const permanentUid = crypto.randomUUID();
...
//       if (result.success) {
//         // FIX 1: window.location.origin is "http://localhost:3000" (already has the protocol)
//         const siteUrl = window.location.origin; 
//         const fullPath = `${siteUrl}/pay/${professionalSlug}`;
...
//             <p style={{ color: '#2e7d32', fontSize: '10px', margin: 0 }}>KES {grandTotal.toLocaleString()} ÷ {peopleCount}</p>
//           </div>
//           <div style={{ textAlign: 'right', fontSize: '11px', color: '#2e7d32' }}>
//             <p style={{ margin: 0 }}>Bill KES {totalAmount.toLocaleString()}</p>
//             <p style={{ margin: 0 }}>+ KES {serviceFee} fee</p>
//           </div>
//         </div>
...
//           style={{ width: '100%', padding: '20px', backgroundColor: '#4caf50', color: '#0a0a0a', border: 'none', borderRadius: '16px', fontWeight: '900', fontSize: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', cursor: isSubmitting ? 'not-allowed' : 'pointer' }}
//         >
